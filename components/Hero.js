        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" >
                    ...
                    <h2>Official page for Dubai Residences payment. Please make your payments on this page only. Also scroll below for more information</h2>
                ...
                <div className="col-lg-6 order-1 order-lg-2 hero-img">
                    <img src="/assets/img/emirates-id.png" className="img-fluid animated" alt="" />
                </div>
            </div>
        </div>
